...
*Правила*
- У игрока 3 жизни.
- Каждый пришелец добравшийся до земли отнимает одну жизнь.
- Если по игроку попала пуля пришельца у него отнимается одна жизнь.
- Если пришелец врезается в игрока, у него отнимается одна жизнь.
...
- Обновление всех сущностей происходит с помощью вызова функции update для каждого элемента игровых объектов (полиморфизм).
